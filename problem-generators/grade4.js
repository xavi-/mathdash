function grade4() {
	...
	if(rnd < 0.15) { // Addition
		...
		num2 = Math.floor(30 * Math.random());
		return { question: num1 + " + " + num2, answer: num1 + num2 };
	} else if(rnd < 0.35) { // Subtracion
		num1 = Math.floor(40 * Math.random());
		...
		num1 = Math.floor(6 * Math.random()) + 4;
		num2 = Math.floor(8 * Math.random()) + 2;
		return { question: num1 + " * " + num2, answer: num1 * num2 };
	} else if(rnd < 0.85) {
		num1 = Math.floor(10 * Math.random());
		num2 = Math.floor(10 * Math.random());
		...
		num1 = Math.floor(9 * Math.random()) + 1;
		num2 = Math.floor(9 * Math.random()) + 1;
